        ...
        Event.createEvent(deepCopy(event1JSON),
            ...
            function(errEvent, eventInstance) {
                ...
                Event.inviteFriend_Id(eventInstance._id, userId, invite, function(err) {
                    ...
                    Event.respond_To_Invitation(eventInstance._id, userIds[1], true, function(err, event) {
                        if (err) {
        ...
        Event.createEvent(deepCopy(event1JSON),
            ...
            function(errEvent, eventInstance) {
                ...
                Event.inviteFriend_Id(eventInstance._id, userId, invite, function(err) {
                    ...
                    Event.respond_To_Invitation(eventInstance._id, userIds[1], false, function(err, event) {
                        if (err) {
                            done("failed on accept inviting: " + err);
                            return;
                        }
